...
from .gltf import *
from .blender import *
from .sketchfab import Config, Utils
...
class SketchfabApi:
    ...
    def login(self, email, password):
        url = '{}&username={}&password={}'.format(Config.SKETCHFAB_OAUTH, email, password)
        if True:
...
class LoginModal(bpy.types.Operator):
    ...
    def invoke(self, context, event):
        ...
        if not login_props.password:
            ...
            url = '{}&username={}&password={}'.format(Config.SKETCHFAB_OAUTH, login_props.email, login_props.password)
